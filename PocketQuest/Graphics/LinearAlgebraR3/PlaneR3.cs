namespace LinearAlgebra
{
    public class PlaneR3
    {
        ...
        public double GetEQConstants(int constant)
        {
            ...
            {
                case A:
                    value = GetNormal().Get(CoordinateR3.X);
                    break;
                case B:
                    value = GetNormal().Get(CoordinateR3.Y);
                    break;
                case C:
                    value = GetNormal().Get(CoordinateR3.Z);
                    break;
                case D:
        ...
        public double F(PointR3 p)
        {
            ...
            x = p.Get(CoordinateR3.X);
            y = p.Get(CoordinateR3.Y);
            z = p.Get(CoordinateR3.Z);
